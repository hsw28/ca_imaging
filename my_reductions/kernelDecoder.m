function decodeResults = kernelDecoder(animalName, nPerms)
  %~~~~decodes its own day
  ...
  %
  %uses a nonlinear (RBF) kernel, but it operates in the full neurons × timebins space.
  %This is a high-dimensional nonlinear classifier, not a 2D one.
