% simulate SDM model using W, then calculate log-marginals
...
result1 = lmarginal_dynamic_panel(y_slx,xo,W,N,T); 
...
result2 = lmarginal_dynamic_panel(y_sdm,xo,W,N,T); 
...
result3 = lmarginal_dynamic_panel(y_sdem,xo,W,N,T); 
