...
mindparameters.lm.n = length(testdata.t); %number of landmarks?? can be given as, for ex, round(size(dataDFF,1)/2). we dont want to use landmarks so I think this should be equal to number of data points?
...
mindparameters.embed.type = 'rwe';  %no idea
mindparameters.embed.d = nan;       %no idea
...
mindparameters.mapping.k = [1:10, 15:5:50]; % choices of k for k nearest neighbors
