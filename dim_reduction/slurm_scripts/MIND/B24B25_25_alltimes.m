...
%B24B25_24 = alignment_medium(B24B25,17);
...
%time24 = vel(2,:);
%moving24 = (Ca_traces.CA_traces_2023_05_24(B24B25_24,wanted24));
%result_B24B25_24 = runMIND(moving24, time24)


vB24B25 = find(alignment_medium(:,17)>0 & alignment_medium(:,18)>0);
vB24B25_25 = alignment_medium(vB24B25,18);
moving25 = (Ca_traces.CA_traces_2023_05_25(vB24B25_25,:));
...
save result_B24B25_25_alltimes.mat result_B24B25_25
