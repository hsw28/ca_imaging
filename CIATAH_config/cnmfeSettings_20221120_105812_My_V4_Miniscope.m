% From original settings file: C:\Users\holdb\Documents\Programming\ciatah\ciapkg\settings\cnmfeSettings.m
% Biafra Ahanonu
% 2019.04.04 [10:35:15]
...
cnmfeOpts.memory_size_to_use = 16; %
% Float: GB, memory space you allow to use in MATLAB
cnmfeOpts.memory_size_per_patch = 6; % 0.6
...
cnmfeOpts.min_corr = 0.5;
% minimum peak-to-noise ratio for a seeding pixel
cnmfeOpts.min_pnr = 5;
cnmfeOpts.bd = 3;             % number of rows/columns to be ignored in the boundary (mainly for motion corrected data)
