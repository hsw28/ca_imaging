...
#SBATCH --job-name="shuff_trace\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=shuff_trace.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
...
matlab -batch -nodisplay -nosplash -nodesktop -r "addpath(genpath('/home/hsw967/Programming/ca_imaging')); addpath(genpath('/home/hsw967/Programming/data_analysis/hannah-in-use/matlab/')); mutualinfo_openfield_trace_shuff_4SLURM; exit;"
