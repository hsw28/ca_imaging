function results = pos_decoding_complete_shuff(pos_for_model, spikes_for_model, pos_for_decoding, spikes_for_decoding, tdecode, dim, velthreshold, alignmentdata1, alignmentdata2, iters)
