        ...
        for i = 1:numel(selected_folders)
            ...
            if selected_folder_idx > 0 && selected_folder_idx <= numel(validFolders)
                ...
                if type1_for_cage_2_for_oval == 1
                  ...
                  giantStructure.(sprintf('pos_%s_oval', pos_folder_date')) = output;
...
function [output, type1_for_cage_2_for_oval] = processSelectedFolder(folder)
    ...
    timeStampData = readtable(timeStampFile,'PreserveVariableNames',true);
    ...
    output = dlc_fixpos(pos, timeStampData, type1_for_cage_2_for_oval);
