function [wanted goodCA_trace env_CSUS] = movingtimetraining(trace, CS_timestoconvert, US_timestoconvert, CA_timestamps, pos, put_1_for_a_2_for_b, velthreshold)
